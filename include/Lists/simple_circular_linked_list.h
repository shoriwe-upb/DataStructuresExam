...
SimpleCircularLinkedList_find(struct SimpleCircularLinkedList *list, is_equal_condition condition) {
...
bool SimpleCircularLinkedList_remove_by_index(struct SimpleCircularLinkedList *list, unsigned long long int index,
                                              bool delete_object) {
...
bool SimpleCircularLinkedList_insert(struct SimpleCircularLinkedList *list, unsigned long long int index, void *value,
                                     size_t size) {
...
bool SimpleCircularLinkedList_set(struct SimpleCircularLinkedList *list, unsigned long long int index, void *value,
                                  size_t size,
                                  bool delete_old) {
...
SimpleCircularLinkedList_sub_list(struct SimpleCircularLinkedList *list, unsigned long long int start,
