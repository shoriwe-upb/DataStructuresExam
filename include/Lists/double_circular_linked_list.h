...
DoubleCircularLinkedList_find(struct DoubleCircularLinkedList *list, is_equal_condition condition) {
...
bool DoubleCircularLinkedList_remove_by_index(struct DoubleCircularLinkedList *list, unsigned long long int index,
                                              bool delete_object) {
...
bool DoubleCircularLinkedList_insert(struct DoubleCircularLinkedList *list, unsigned long long int index, void *value,
                                     size_t size) {
...
bool DoubleCircularLinkedList_set(struct DoubleCircularLinkedList *list, unsigned long long int index, void *value,
                                  size_t size,
                                  bool delete_old) {
...
DoubleCircularLinkedList_sub_list(struct DoubleCircularLinkedList *list, unsigned long long int start,
